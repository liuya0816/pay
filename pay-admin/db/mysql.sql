...
--支付菜单
INSERT INTO `sys_menu` ( `parent_id`, `name`, `url`, `perms`, `type`, `icon`, `order_num`) VALUES ( '0', '账户安全', NULL, NULL, '0', 'fa fa-cog', '1');
INSERT INTO `sys_menu` ( `parent_id`, `name`, `url`, `perms`, `type`, `icon`, `order_num`) VALUES ( '0', '账户管理', NULL, NULL, '0', 'fa fa-cog', '2');
INSERT INTO `sys_menu` ( `parent_id`, `name`, `url`, `perms`, `type`, `icon`, `order_num`) VALUES ( '0', '商户管理', NULL, NULL, '0', 'fa fa-cog', '3');
INSERT INTO `sys_menu` ( `parent_id`, `name`, `url`, `perms`, `type`, `icon`, `order_num`) VALUES ( '0', '交易管理', NULL, NULL, '0', 'fa fa-cog', '4');
INSERT INTO `sys_menu` ( `parent_id`, `name`, `url`, `perms`, `type`, `icon`, `order_num`) VALUES ( '0', '报表下载', NULL, NULL, '0', 'fa fa-cog', '5');
INSERT INTO `sys_menu` ( `parent_id`, `name`, `url`, `perms`, `type`, `icon`, `order_num`) VALUES ( '0', '通道管理', NULL, NULL, '0', 'fa fa-cog', '6');
